...
window.toggleAdvanceSearch = toggleAdvanceSearch;
	...
	<ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav ml-0">
		<li class="nav-item"><a class="nav-link active" href="{{url('/Settings')}}"><span>Default</span></a></li>
				<li class="nav-item"><a class="nav-link " href="{{url('/general')}}"><span>General</span></a></li>
				<li class="nav-item"><a class="nav-link " href=""><span>Custom</span></a></li>
				<li class="nav-item"><a class="nav-link " href=""><span>API</span></a></li>
				<li class="nav-item"><a class="nav-link " href=""><span>Email</span></a></li>
				<li class="nav-item"><a class="nav-link " href=""><span>Payment</span></a></li>
				<li class="nav-item"><a class="nav-link " href=""><span>Constants</span></a></li>
				<li class="nav-item"><a class="nav-link " href=""><span>Social</span></a></li>
